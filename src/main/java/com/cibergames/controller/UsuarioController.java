...
public class UsuarioController {
	...
	public String grabarRegistroUsuario(Model model,@ModelAttribute @Valid Usuario usuario, 
		...
		model.addAttribute("mensajeConfirmacion", "Usuario registrado correctamente.");
			

		return "RegistroUsuario";
		}
		catch (Exception e) {
			model.addAttribute("mensajeDenegado", "Algo ocurrió! No pudo registrarse el Usuario.");
			return "RegistroUsuario";
		}
